...
def deep_get(data: dict[str, Any], path: str, default: Any = None) -> Any:
    """Return a nested value from a dict using dot notation."""
    current: Any = data
...
class Settings:
    ...
    def database_url(self) -> str:
        return os.getenv(
            "DATABASE_URL",
            "postgresql://trader:trader_password@localhost:5432/quantumtrader",
        )
    ...
    def mongo_db(self) -> str:
        return os.getenv("MONGO_DB", "quantumtrader")
